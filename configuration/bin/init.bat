...
FOR /F "usebackq delims=" %%x IN ("%ROOT_DIR%\configuration\%PENTAHO_ENV%\env.conf") DO (SET %%x)

REM Set Additional Variables
SET KETTLE_CLIENT_DIR="%PENTAHO_HOME%\design-tools\data-integration"
SET KETTLE_HOME=%ROOT_DIR%\configuration\%PENTAHO_ENV%
SET KETTLE_META_HOME=%ROOT_DIR%\configuration\%PENTAHO_ENV%
